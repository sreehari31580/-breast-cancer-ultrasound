...
print("=== SIMPLE RESNET18 TEST (TINY BALANCED SUBSET) ===")
...
def train_simple_model():
    ...
    train_csv = "cnn_data/tiny_balanced_train.csv"
    test_csv = "cnn_data/tiny_balanced_test.csv"
    ...
    plt.title('Confusion Matrix - Simple EfficientNetB0 (Tiny Balanced Subset)')
    plt.xlabel('Predicted')
    plt.ylabel('True')
    plt.tight_layout()
    plt.savefig('simple_model_confusion_matrix_tiny_balanced.png')
    print("Confusion matrix saved as simple_model_confusion_matrix_tiny_balanced.png")
    torch.save(model.state_dict(), "simple_efficientnetb0_model_tiny_balanced.pth")
    print("Simple model saved as simple_efficientnetb0_model_tiny_balanced.pth")
